export default function Inventory() {
  ...
  return (
    <div className="space-y-8 animate-in slide-in-from-bottom-4">
      <h2 className="text-2xl font-black uppercase tracking-tighter text-blue-950">Asset Registry</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {assets.map((asset) => (
          <div key={asset.id} className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm border-t-8 border-t-blue-600">
            ...
            <h4 className="text-lg font-black text-slate-800 uppercase tracking-tighter">{asset.name}</h4>
